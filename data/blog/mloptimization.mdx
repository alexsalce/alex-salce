...
date: 'January 2025'
tags: ['SDS program', 'machine learning', 'optimization', 'gradient descent', 'variance reduction', 'stochastic gradient descent', 'statistics', 'python']
layout: PostBanner
...
+ [ADAM and SARAH Optimization Paper](/static/files/ml_optimization/SIE596_FinalProject_VR_SARAH_ADAM_Salce.pdf)

+ [ADAM and SARAH Optimization Slides](/static/files/ml_optimization/SIE_596_Final_Presentation_SARAH_ADAM_Salce.pdf)
...
![stochasics](/static/files/ml_optimization/images/stochastics1.png#center)
</div>
...
{/* 
## [Crash Course: Gradient Descent](/blog/mloptimization/gd)

*This section is some entry-level background to machine learning concepts, [so please skip if you already have a grasp](#stochastic-gradient-descent).*
...
*See [appendix](#full-gradient-calculation) for more details on full and stochastic gradient calculation*.

In terms of complexity, each step has $p \cdot n$ calculations per step. It can be shown that since $f$ is convex and Lipschitz continuous, for $\alpha$ selected carefully using what is called the Lipschitz constant $L$ ([you can learn more about Lipschitz continuity here](https://www.youtube.com/watch?v=UjvFFXakMks&t=418s) or in the [appendix](#lipschitz-continuity)) , that after $T$ iterations the following will hold.
...
## [Stochastic Gradient Descent](/blog/mloptimization/stochasticgd)
...
*See [appendix](#stochastic-gradient-calculation) for more details on stochastic gradient calculation*.
...
## [Variance Reduction Techniques](/blog/mloptimization/variancereduction)
...
*See [appendix](#batch-gradient-calculation) for example calculation details*
...
## [SARAH and ADAM Algorithms](/blog/mloptimization/sarahadam)
## SARAH
...
Methodology in this section is drawn from *SARAH: A Novel Method for Machine Learning Problems Using Stochastic Recursive Gradient* [@nguyen] ([link](https://arxiv.org/abs/1703.00102))
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  ...
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    ![SARAH and SVRG run same inner and outer loops](/static/files/ml_optimization/images/sarahsvrg.png)
  </div>
</div>
...
Methodology in this section is drawn from *Adam: A Method for Stochastic Optimization* [@kingma] ([link](https://arxiv.org/abs/1412.6980)). 
...
> [!NOTE] 
> $g_t^2$ is equivalent to element-wise multiplication of gradients $g_1 \odot g_2$
...
*We will follow the derivation of the bias terms as in* @kingma
...
All code for diagrams and accompanying paper [is available here](https://github.com/alexsalce/UA-SDS/tree/main/ml_optimization).
...
*Return to*
+ [Gradient Descent in Machine Learning](/blog/mloptimization/gd#gradient-descent-in-machine-learning)
+ [SVRG Convergence](/blog/mloptimization/sarahadam#svrg-convergence)
...
*Return to*
+ [Limitations of Regular Gradient Descent](/blog/mloptimization/gd#limitations-of-regular-gradient-descent)

### Consistency

Informally, a *[consistent estimator](https://en.wikipedia.org/wiki/Consistent_estimator)* just means that if we use more data to estimate a parameter, it is guaranteed to converge to the true value of the parameter.
...
*Return to*
+ [Limitations of Regular Gradient Descent](/blog/mloptimization/gd#limitations-of-regular-gradient-descent)
+ [Stochastic Gradient Descent](/blog/mloptimization/stochasticgd#stochastic-gradient-descent)
...
*Return to*
+ [Minibatch SGD](/blog/mloptimization/variancereduction#minibatch-sgd)
