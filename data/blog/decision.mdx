...
<img src="files/decision/images/objdiag.png" alt="Decision - Tool A" width="400"/> 
...
<img src="files/decision/images/decision_options.png" alt="Decision Frame" width="400"/> 
...
<img src="files/decision/images/decision_a.png" alt="Decision - Tool A" width="400"/> 
...
<img src="files/decision/images/decision_b.png" alt="Decision - Tool B" width="400"/> 
...
<img src="files/decision/images/decision_c.png" alt="Decision - Tool C" width="400"/> 
...
<img src="files/decision/images/decision_donothing.png" alt="Decision - Do Nothing" width="400"/> 
...
<img src="files/decision/images/decision_pyramid.png" alt="Decision Frame Pyramid" width="800"/> 
...
$$Quote\left(X_{tool}\right)\ \ast\ 10yrs$$
...
$$Development_{MBSE}\left(X_{tool}\right)=manyrs_{MBSE}\left(X_{tool}\right)\ast\left(5M/manyear\right)$$
...
$$t_2=I\left(X_{tool}\ development\ successful\right)\ast\frac{manyrs_{OP}\left(X_{tool}\right)}{FTH_{OP}}$$

Where $\ I\left(X_{tool}\ development\ successful\right)$ is the indicator function (value of 1 if selected tool development successful, and 0 otherwise.)
...
$$Development_{OP}\left(X_{tool}\right)=manyrs_{OP}\left(X_{tool}\right)\ast\left(5M/manyear\right)$$
...
$$Maintain\left(X_{tool}\right)\ =\ I\left(X_{tool}\neq T o o l\ A\right)\ast17.5M\$$
...
$$Penalty(\left(t_{1i},t_2\right)\ =\$100M\ast I\left(\sum_{i\ \in a t t e m p t s} t_{1i}+t_2\geq3\right))$$
...
$$Cost\left(X_{tool}\right)=\ Development_{MBSE}\left(X_{tool}\right)\ +\ Development_{OP}\left(X_{tool}\right)\ +\ Quote\left(X_{tool}\right)\ \ast\ 10yrs$$
$$\ +\ Maintain\left(X_{tool}\right)+Penalty(\left(t_{1i},t_2\right)$$
...
$$Profit\left(X_{tool}\right)=\ \$10000\ -\ Cost\left(X_{tool}\right)\ \ $$
...
<img src="files/decision/images/decision_influence.png" alt="Influence Diagram" width="800"/> 
...
|---|---|
|Development Time|	Inputs to development time consist of the MBSE development man*year estimate for the selected tool and pass through the development successful/unsuccessful node depending on the realized outcome. The “Available Resources” input to this node and are used with the man*year estimates to calculate time for each development outcome that is realized.  Calculated total development time is then passed into Penalties node.|
...
<img src="files/decision/images/decision_tree.png" alt="Decision Tree" width="800"/> 
...
<img src="files/decision/images/decision_params.png" alt="Decision Tree Parameters" width="800"/> 
...
<img src="files/decision/images/decision_torspidiagram.png" alt="Tornado and Spider Diagrams" width="800"/> 
...
<img src="files/decision/images/decision_sensitivity.png" alt="Sensitivity Analysis" width="800"/> 
...
<img src="files/decision/images/decision_recommendation.png" alt="Recommendation" width="800"/> 
...
<img src="files/decision/images/decision_risktree.png" alt="Decision Tree with Risk Attitude" width="800"/> 
...
<img src="files/decision/images/decision_torspidiagramrisk.png" alt="Tornado and Spider Diagrams with Risk Attitude" width="800"/> 
...
<img src="files/decision/images/decision_recommendationrisk.png" alt="Recommendation with Risk Attitude" width="800"/> 
...
<img src="files/decision/images/decision_riskneutralfinal.png" alt="Risk Neutral Final Recommendation" width="400"/> 
...
<img src="files/decision/images/decision_risktolerancefinal.png" alt="Risk Neutral Final Recommendation" width="400"/> 
...
+ Howard, RA., Abbas AE. (2016). Foundations of Decision Analysis.  Pearson
