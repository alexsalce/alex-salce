...
$$\text{Cost}\left(X_{tool}\right)=\ \text{Development}_{MBSE}\left(X_{tool}\right)\ +\ \text{Development}_{OP}\left(X_{tool}\right)\ +\ \text{Quote}\left(X_{tool}\right)\ \ast\ 10yrs$$
$$\ +\ \text{Maintain}\left(X_{tool}\right)+\text{Penalty}(\left(t_{1i},t_2\right)$$
