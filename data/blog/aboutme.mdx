...
It's now been about a decade total that I have lived in Tucson, so it feels right to call this place home.  Having been all over the world, there is still no place else that really compares. The Sonoran Desert is such unique territory, and it's truly a special place to live (even though it can get HOT).
