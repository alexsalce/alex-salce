...
![FreeThrow](/static/files/doe/ftgif1.GIF)
...
$$y_{ijkm}=A_{i}+B_{j}+C_{k}+(AB)_{ij}+(AC)_{ik}+(BC)_{jk}+(ABC)_{ijk}+\delta_{m}+\epsilon_{ijkm}\,\,\begin{cases}
i=1,2\\
j=1,2\\
k=1,2\\
m=1,2
