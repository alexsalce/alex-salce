...
// Assets
import Placeholder from 'public/static/files/sml_nba/smlnbalink.png'
    ...
    <Section>
      <Container>
        <div className="flex flex-col items-center text-center">
          <Button asChild className="not-prose mb-6 flex w-fit" size="sm" variant="outline">
            <Link href="https://9d8.dev">
              Lorem ipsum dolor sit amet <ArrowRight className="ml-2 w-4" />
            </Link>
          </Button>
          <h1 className="!mb-0">
            <Balancer>Lorem ipsum dolor sit amet, consectetur adipiscing elit</Balancer>
          </h1>
